...
public class AuthActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle state){super.onCreate(state);repository=AppRepository.get(this);if(repository.session().isLoggedIn()){openApp();return;}setContentView(R.layout.activity_auth);
        ...
        switchMode.setOnClickListener(v->toggleMode());submit.setOnClickListener(v->authenticate());findViewById(R.id.forgot_password).setOnClickListener(v->forgotPassword());findViewById(R.id.google_button).setOnClickListener(v->social("Google"));findViewById(R.id.facebook_button).setOnClickListener(v->social("Facebook"));
    }
